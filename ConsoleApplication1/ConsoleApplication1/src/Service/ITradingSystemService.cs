...
public interface ITradingSystemService
{
    ...
    Collection<string> getItems(string keyWord, string productName, string category,string subCategory, double ratingItem, double ratingStore, double maxPrice, double minPrice);
    ...
    * for example, if userId1 bought 3 "milk" products and 2 "eggs" products from storeId1, there will be 1 purchases for the user. */
    ...
    string addProductToStore(string userID, string storeId, string productName, string category, string subCategory, int quantity, double price) ;
